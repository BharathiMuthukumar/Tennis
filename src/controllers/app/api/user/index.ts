...
import deleteUser from '@src/controllers/app/api/user/deleteUser/{id}/put';

Router.get('/getUser', validationAuthenticator(), getUser());
Router.post('/userRegister', userRegister());
Router.post('/userLogin', userLogin());
Router.put('/updateUser/:id',validationAuthenticator(), updateUser());
Router.put('/deleteUser/:id', validationAuthenticator(),deleteUser());
